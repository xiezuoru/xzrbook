...
def setup_db():
    ...
    if cur.fetchall()[0][0] == 0:
        cur.execute('INSERT INTO sensorlist(sensorid,sensorname,maxvalue,minvalue) VALUES(1,"光线传感器",10000,0)')
        cur.execute('INSERT INTO sensorlist(sensorid,sensorname,maxvalue,minvalue) VALUES(2,"温度传感器",39,5)')
        db.commit()
    ...
    if cur.fetchall()[0][0] == 0:
        ...
        cur.execute("INSERT INTO sensorlog(logid,sensorid,sensorvalue,updatetime) VALUES(2,2,20,'%s')"%now)
